...
export class ProfileComponent implements OnInit {
  ...
  private temp2;
  private temp3;
  constructor(private registrationService: RegistrationService, private router: Router, private blogservice: BlogserviceService) {
  }
  ...
  ngOnInit() {
    this.registrationService.getUser().subscribe(data => {
      ...
      this.phoneNumber = this.viewUser.mobileNo;
      this.temp3 = this.viewUser.mobileNo;
